exports.run = async (Discord, client, message, args, db) => {
    ...
    let embed = new Discord.RichEmbed()
        ...
        .addField(`[1] - ${top1search.Usuario}`,`• XP: ${top1search.XPDisplaycount}\n • Level ${top1search.Level}\n`, true)
        .addField(`[2] - ${top2search.Usuario}`,`• XP: ${top2search.XPDisplaycount}\n • Level ${top2search.Level}\n`, true)
        .addField(`[3] - ${top3search.Usuario}`,`• XP: ${top3search.XPDisplaycount}\n • Level ${top3search.Level}\n`, true)
        .addField(`[4] - ${top4search.Usuario}`,`• XP: ${top4search.XPDisplaycount}\n • Level ${top4search.Level}\n`, true)
        .addField(`[5] - ${top5search.Usuario}`,`• XP: ${top5search.XPDisplaycount}\n • Level ${top5search.Level}\n`, true)
        .addField(`[6] - ${top6search.Usuario}`,`• XP: ${top6search.XPDisplaycount}\n • Level ${top6search.Level}\n`, true)
        .addField(`[7] - ${top7search.Usuario}`,`• XP: ${top7search.XPDisplaycount}\n • Level ${top7search.Level}\n`, true)
        .addField(`[8] - ${top8search.Usuario}`,`• XP: ${top8search.XPDisplaycount}\n • Level ${top8search.Level}\n`, true)
        .addField(`[9] - ${top9search.Usuario}`,`• XP: ${top9search.XPDisplaycount}\n • Level ${top9search.Level}\n`, true)
        .addField(`[10] - ${top10search.Usuario}`,`• XP: ${top10search.XPDisplaycount}\n • Level ${top10search.Level}\n`, true)
        .addField(`[11] - ${top11search.Usuario}`,`• XP: ${top11search.XPDisplaycount}\n • Level ${top11search.Level}\n`, true)
        .addField(`[12] - ${top12search.Usuario}`,`• XP: ${top12search.XPDisplaycount}\n • Level ${top12search.Level}\n`, true)
        .setColor("#6699FF")
        .setFooter("Cisla ©")
        .setTimestamp(new Date())
    message.channel.send(embed).then(msg => msg.delete(40*1000))
        } catch(err) {
            message.reply("ocorreu um erro inesperado. Aguarde para usar este comando.")
        }
}