                                                            ...
                                                            message.author.send(e21).then(async MessageFinish => {
                                                                ...
                                                                collectreactEnviar.on('collect', async r => {
                                                                    ...
                                                                    let SendChannel =  new Discord.RichEmbed()
                                                                        ...
                                                                        .addField("**11**. " + hpergunta11,"*R*: " + hresposta11)
                                                                        .addField("**12**. " + hpergunta12,"*R*: " + hresposta12)
                                                                        .addField("⠀⠀",`Autor: ${message.author}\n *• Use ${db.get("Guild").find({id: message.guild.id}).value().prefix}delForm ID para excluir este formulario, ou ${db.get("Guild").find({id: message.guild.id}).value().prefix}accForm ID para aceitar.*`)
                                                                        .setFooter("Cisla © • Formularios.")
                                                                        .setTimestamp(new Date())
                                                                        .setColor("#6699FF")
                                                                    client.guilds.get("602679739777417256").channels.get("602901921841414164").send(SendChannel).then(msg => {
                                                                                                                                ...
                                                                                                                                message.author.send(Embed).then(async MessageFinish => {
                                                                                                                                    ...
                                                                                                                                    collectreactEnviar.on('collect', async r => {
                                                                                                                                        ...
                                                                                                                                        let SendChannel =  new Discord.RichEmbed()
                                                                                                                                            ...
                                                                                                                                            .setTimestamp(new Date())
                                                                                                                                            .setColor("#6699FF")
                                                                                                                                        client.guilds.get("602679739777417256").channels.get("603685392943808513").send(SendChannel).then(msg => {
